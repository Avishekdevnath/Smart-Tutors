        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-green-100 mb-8 max-w-3xl mx-auto">
              Stay connected with your child's education. Monitor progress, communicate with tutors, and track academic performance in real-time.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our comprehensive guardian portal provides tools and insights to help you stay involved in your child's learning journey.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 text-sm">
              Monitor your child's academic progress with detailed reports and analytics.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 text-sm">
              Connect directly with tutors and teachers through our secure messaging system.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 text-sm">
              View and manage tutoring sessions, homework assignments, and important dates.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 text-sm">
              Receive detailed reports on your child's strengths, areas for improvement, and recommendations.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Get instant notifications about your child's progress and upcoming sessions.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Your child's data is protected with enterprise-grade security measures.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Access to educational experts and support team whenever you need help.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-2xl">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Secure Guardian Access</h3>
                <p className="text-gray-600 mb-6">
                  Join thousands of parents who trust our platform to support their children's education journey.
                </p>
                <Link href="/contact">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join our community of engaged parents and give your child the support they need to succeed.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button className="bg-gradient-to-r from-green-600 to-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-green-700 hover:to-blue-700 transition-all duration-200 transform hover:scale-105">
                  Contact Us
                </button>
              </Link>
              <Link href="/tutors">
