...
export default function TutorDashboard() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "completed": return "bg-[#006A4E]";
  ...
  return (
    <TutorDashboardLayout title="Dashboard" description={`Welcome back, ${dashboardData.tutor.name || "Tutor"}!`}>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-blue-100">
                <svg className="w-6 h-6 text-[#006A4E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-purple-100">
                <svg className="w-6 h-6 text-[#E07B2A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center p-4 bg-[#006A4E]/8 rounded-lg">
                <div className="text-2xl font-bold text-[#006A4E]">{dashboardData.stats.totalApplications}</div>
              ...
              <div className="text-center p-4 bg-[#E07B2A]/8 rounded-lg">
                <div className="text-2xl font-bold text-[#E07B2A]">{dashboardData.stats.completedApplications}</div>
      ...
      {/* Quick Stats Summary */}
      <div className="bg-[#006A4E] rounded-lg p-6 text-white">
